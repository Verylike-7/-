...
const ClassStudent = Vue.extend({
    ...
    <div style="padding: 20px">
         ...
         <div style="display: flex; justify-content: left">
          ...
          <el-table :data="tableData" style="width: 100%"  row-key="id" border header-align="center">
            ...
            <el-input v-model="form.enterdate"></el-input>
            </el-form-item>
        ...
        <div v-show="false">
          <form id="exportForm" action="http://localhost:8088/student/export" method="get">
           </form>
            <form id="importForm" action="http://localhost:8088/student/import" method="post">
    ...
    methods: {
        ...
        confirmForm() {
            //判断新增还是修改
            if (this.isEdit) {
                axios.put("/student/update", this.form)
                    .then(
                        () => {
                ...
                axios.post("/student/save", this.form)
                    .then(
                        () => {
                            this.dialogVisible = false;
                            this.queryByPage(1);
