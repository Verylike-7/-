...
const AuthRole = Vue.extend({
     ...
     <div style="padding: 20px">
         <el-card class="operate-container" shadow="never" style="margin-bottom: 10px">
          ...
          <el-table :data="tableData" style="width: 100%"  row-key="id" border header-align="center">
              ...
              <el-table-column align="center" prop="description" label="描述" width="280"></el-table-column>
  ...
  methods: {
    ...
    confirmMenuAuth() {
      ...
      // 结合roleId发送到服务端
      axios.put("/role/menu/", {id: this.currentRoleId, menuIds: menuIds})
        .then(() => {
          // 关闭窗口
