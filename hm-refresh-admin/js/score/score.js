...
const Score = Vue.extend({
     ...
     <div style="padding: 20px">
         ...
         <div style="display: flex; justify-content: left">
          ...
          <el-table-column align="center" prop="id" label="编号" width="250"></el-table-column>
              <el-table-column align="center" prop="sid" label="学生编号" width="250"></el-table-column>
              <el-table-column align="center" prop="cno" label="课程编号" width="250"></el-table-column>
              <el-table-column align="center" prop="degree" label="课程分数" width="250"></el-table-column>
        ...
        <div v-show="false">
          <form id="exportForm" action="http://localhost:8088/score/export" method="get">
           </form>
            <form id="importForm" action="http://localhost:8088/score/import" method="post">
    ...
    methods: {
        handleUpload() {
            ...
            axios.post("/score/import", formData, config)
        ...
        confirmForm() {
            //判断新增还是修改
            if (this.isEdit) {
                axios.put("/score/update", this.form)
                    .then(
                        () => {
                ...
                axios.post("/score/save", this.form)
                    .then(
                        () => {
                            this.dialogVisible = false;
                            this.queryByPage(1);
